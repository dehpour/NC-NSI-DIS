...
FLUX_NU_ND    = pd.read_csv('./flux/TauOptimized_neutrino_LBNEND_globes_flux.csv', header=None)
FLUX_NUBAR_ND = pd.read_csv('./flux/TauOptimized_antineutrino_LBNEND_globes_flux.csv', header=None)

F_mu_ND    = FLUX_NU_ND[2]
F_mubar_ND = FLUX_NUBAR_ND[5]

FLUX_NU_FD    = pd.read_csv('./flux/TauOptimized_neutrino_LBNEFD_globes_flux.csv', header=None)
FLUX_NUBAR_FD = pd.read_csv('./flux/TauOptimized_antineutrino_LBNEFD_globes_flux.csv', header=None)
